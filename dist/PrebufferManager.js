...
class CameraBuffer {
    ...
    killChild() {
        ...
        this.pendingMoof = undefined;
        try {
            (_a = this.child) === null || _a === void 0 ? void 0 : _a.kill("SIGKILL");
        }
    ...
    createStream(cameraKey, sinceEpochMs) {
        ...
        const armDeadman = () => {
            ...
            deadman = setTimeout(() => {
                ...
                try {
                    stream === null || stream === void 0 ? void 0 : stream.push(null);
                }
        ...
        const onFragment = (f) => {
            ...
            if (queue.length >= MAX_QUEUED_FRAGMENTS) {
                ...
                try {
                    stream === null || stream === void 0 ? void 0 : stream.destroy(new Error("prebuffer consumer stalled"));
                }
